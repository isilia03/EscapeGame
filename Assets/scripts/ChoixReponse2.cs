...
public class ChoixReponse2 : MonoBehaviour
{
    ...
    private string[] Reponses2 = new string[] { "4 Février", "Une sorcière pratiquant la magie médicinale", "5" };
    private string[] Reponses3 = new string[] { "Avec une boule de cristal", "La nuit d'halloween", "Non" };
    private string[] Reponses4 = new string[] { "Un mangeur d'hommes", "Envoûter", "oncube" };
